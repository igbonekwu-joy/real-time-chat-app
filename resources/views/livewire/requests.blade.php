                        ...
                        <div id="discussions" class="tab-pane fade active show">
                            <div class="search">
                                <form class="form-inline position-relative">
                                    <input type="search" class="form-control" id="conversations" placeholder="Search for requests..." wire:model.live.debounce.300ms="request">
                                ...
                                <div class="list-group request-list-{{ auth()->user()->id }}" id="chats" role="tablist">
                                    ...
                                    @foreach($requests as $request)
                                        <a
                                            ...
                                            id="user-list"
                                            wire:click.prevent="selectUser({{ $request->user->id }})"
                                            wire:key="user-{{ $request->id }}"
                                        >
                                            @if($request->user->image)
                                                <img class="avatar-md" src={{ asset('storage') . '/'. $request->user->image }} data-toggle="tooltip" data-placement="top" title="Janette" alt="avatar">
                                            @else
                                                <div class="avatar-md">
