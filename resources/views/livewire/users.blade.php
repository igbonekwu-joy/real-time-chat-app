        ...
        <section class="section about-section gray-bg" id="about">
            <div class="container">
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-lg-6">
                        <div class="about-text go-to">
                            <h3 class="dark-color">About <span class="username">Me</span></h3>
                            <h6 class="theme-color lead" id="about">A Lead UX &amp; UI designer based in Canada</h6>
                            <div class="row about-list">
                                <div class="col-md-6">
                                    <div class="">
                                        <label>E-mail</label><br/>
                                        <p id="email">info@domain.com</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="">
                                        <label>Username</label> <br/>
                                        <p class="username">820-885-3321</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="loader-container">
                    <button class="btn btn-primary loader" style="background: #2196f3; width: 80%;">
